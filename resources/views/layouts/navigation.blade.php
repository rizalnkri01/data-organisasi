      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="" class="flex ml-2 md:mr-24">
            <img src="/build/assets/logo.png" class="h-10 mr-10" alt="FlowBite Logo">
          </a>
              ...
              <div>
                <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                  ...
                  @if (Auth::user()->image == null)
                    <img class="w-8 h-8 rounded-full" src="{{ asset('storage/profile/default.png') }}" alt="IPNU" >
                  @else
                    <img class="w-8 h-8 rounded-full" src="storage/profile/{{ Auth::user()->image }}" alt="{{ Auth::user()->name }}">
                  @endif
                </button>
              </div>
              <!-- Dropdown menu -->
