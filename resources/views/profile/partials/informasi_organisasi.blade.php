...
@foreach ($informasi_organisasi as $data)
    <div class="grid grid-cols-6 gap-6 mt-5">
        ...
        <div class="col-span-6 sm:col-span-3">
            ...
            <input type="text" name="periode" id="periode" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="2023 - 2025" value="{{ $data->periode }}">
        </div>
        <div class="col-span-6 sm:col-span-3">
