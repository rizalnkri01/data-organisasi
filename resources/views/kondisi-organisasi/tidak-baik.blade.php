<x-app-layout>
    ...
    <!-- Pencarian -->
    @include('kondisi-organisasi.partials-tidak-baik.pencarian')
    
    <!-- Tabel -->
    @include('kondisi-organisasi.partials-tidak-baik.tabel')

    <!-- Paginasi -->
    @include('kondisi-organisasi.partials-tidak-baik.paginasi')
</x-app-layouts>