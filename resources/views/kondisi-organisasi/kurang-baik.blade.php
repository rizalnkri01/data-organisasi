<x-app-layout>
    ...
    <!-- Pencarian -->
    @include('kondisi-organisasi.partials-kurang-baik.pencarian')
    
    <!-- Tabel -->
    @include('kondisi-organisasi.partials-kurang-baik.tabel')

    <!-- Paginasi -->
    @include('kondisi-organisasi.partials-kurang-baik.paginasi')
</x-app-layouts>